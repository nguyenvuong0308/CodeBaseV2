...
import com.core.ads.databinding.GntMediumCtaRightBinding
...
class NativeMediumCtaRightTemplateView @JvmOverloads constructor(
    ...
    private val binding: GntMediumCtaRightBinding by lazy {
        GntMediumCtaRightBinding.inflate(LayoutInflater.from(context), this)
    }
