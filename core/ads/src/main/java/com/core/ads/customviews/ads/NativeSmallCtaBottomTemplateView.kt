...
import com.core.ads.databinding.GntSmallCtaBottomTemplateViewBinding
...
class NativeSmallCtaBottomTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntSmallCtaBottomTemplateViewBinding by lazy {
        GntSmallCtaBottomTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
