...
import com.core.ads.databinding.GntSmallLongTemplateViewBinding
...
class NativeSmallLongTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntSmallLongTemplateViewBinding by lazy {
        GntSmallLongTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
