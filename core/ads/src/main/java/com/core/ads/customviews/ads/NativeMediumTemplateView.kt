...
import com.core.ads.databinding.GntMediumTemplateViewBinding
...
class NativeMediumTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntMediumTemplateViewBinding by lazy {
        GntMediumTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
