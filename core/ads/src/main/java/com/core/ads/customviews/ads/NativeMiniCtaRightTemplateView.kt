...
import com.core.ads.databinding.GntMiniCtaRightBinding
import com.core.ads.databinding.GntSmallCtaRightBinding
...
class NativeMiniCtaRightTemplateView @JvmOverloads constructor(
    ...
    private val binding: GntMiniCtaRightBinding by lazy {
        GntMiniCtaRightBinding.inflate(LayoutInflater.from(context), this)
    }
...
//        }
    ...
    override fun applyTemplateStyles(styles: NativeTemplateStyle) {
        ...
        styles.callToActionBorderColor?.let {
            (binding.layoutCta.background as? GradientDrawable)?.setStroke(resources.getDimensionPixelSize(R.dimen._1dp), it.toColorInt())
        }
