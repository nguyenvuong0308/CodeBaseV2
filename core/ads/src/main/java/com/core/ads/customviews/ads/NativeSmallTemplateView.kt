...
import com.core.ads.databinding.GntSmallTemplateViewBinding
...
class NativeSmallTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntSmallTemplateViewBinding by lazy {
        GntSmallTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
