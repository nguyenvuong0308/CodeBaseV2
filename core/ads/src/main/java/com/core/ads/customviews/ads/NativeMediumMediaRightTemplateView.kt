...
import com.core.ads.databinding.GntMediumMediaRightBinding
...
class NativeMediumMediaRightTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntMediumMediaRightBinding by lazy {
        GntMediumMediaRightBinding.inflate(LayoutInflater.from(context), this)
    }
    ...
    override fun setNativeAd(nativeAd: NativeAd) {
        ...
        nativeAd.icon?.let {
            ...
            if (context.isValidGlideContext()) {
                Glide.with(this)
                    .load(it.drawable)
                    .override(resources.getDimensionPixelSize(R.dimen._36dp))
