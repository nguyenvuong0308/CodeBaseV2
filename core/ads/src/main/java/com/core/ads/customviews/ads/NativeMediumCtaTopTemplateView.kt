...
import com.core.ads.databinding.GntMediumCtaTopTemplateViewBinding
...
class NativeMediumCtaTopTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntMediumCtaTopTemplateViewBinding by lazy {
        GntMediumCtaTopTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
