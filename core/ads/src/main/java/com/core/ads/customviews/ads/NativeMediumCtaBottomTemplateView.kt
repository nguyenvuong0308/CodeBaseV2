...
import com.core.ads.databinding.GntMediumCtaBottomTemplateViewBinding
...
class NativeMediumCtaBottomTemplateView @JvmOverloads constructor(
    ...
    private val binding: GntMediumCtaBottomTemplateViewBinding by lazy {
        GntMediumCtaBottomTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
