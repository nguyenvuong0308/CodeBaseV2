...
import com.core.ads.databinding.GntMediumMediaLeftBinding
...
class NativeMediumMediaLeftTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntMediumMediaLeftBinding by lazy {
        GntMediumMediaLeftBinding.inflate(LayoutInflater.from(context), this)
    }
