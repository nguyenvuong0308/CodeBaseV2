...
import com.core.ads.databinding.GntFullCtaBottomTemplateViewBinding
...
class NativeFullCtaBottomTemplateView @JvmOverloads constructor(
    ...
    private val binding: GntFullCtaBottomTemplateViewBinding by lazy {
        GntFullCtaBottomTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
