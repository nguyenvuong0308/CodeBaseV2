...
import com.core.ads.databinding.GntSmallCtaTopTemplateViewBinding
...
class NativeSmallCtaTopTemplateView @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {

    private val binding: GntSmallCtaTopTemplateViewBinding by lazy {
        GntSmallCtaTopTemplateViewBinding.inflate(LayoutInflater.from(context), this)
    }
